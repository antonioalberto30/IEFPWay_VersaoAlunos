        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    if( isset($_POST["form-username"]) && isset($_POST["form-email"]) && isset($_POST["form-contact"])
                        && isset($_POST["form-password"]) && isset($_POST["form-confirm-password"])
                        && isset($_POST["form-card-number"])  && isset($_POST["form-card-name"])
                        && isset($_POST["form-card-csv"])  && isset($_POST["form-card-expiration"])
                    ){
                        ...
                        */
                        ...
                        $sql_user = $conn->prepare("INSERT INTO user(name,email,contact,password, card_id) VALUES (?,?,?,?,?);");
                        $sql_user->bind_param("sssss", $_POST["form-username"], $_POST["form-email"], $_POST["form-contact"],$_POST["form-password"], $cardId);
                        $sql_user->execute();
